...
def main(args):
    ...
    if args.command == "calibrate":
        ...
        far_offset = target["center"][1] - far_y

        input("Move the robot close and press Enter")
        robot, target, _ = get_positions()
